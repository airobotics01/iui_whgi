...
class KoreanCharacterDrawing(ShapeDrawing):
    ...
    def __init__(self, name="korean_character_drawing", color=(1.0, 0.5, 0.2, 1.0), character = '', robot = "", controller = None):
        ...
        # '아' 글자의 각 획에 대한 좌표점 정의 (x, y, z 좌표)
        # 정면에서 그리므로 x축은 고정되고 y, z 좌표가 변경됨

        # self.strokes = [
        #     # 첫 번째 획 - 'ㅇ'을 하나의 원으로 정의 (y, z 평면에서 원 그리기)
        #     [
        #         (0.0, 0.3, 0.7), (0.0, 0.2, 0.65), (0.0, 0.2, 0.55), (0.0, 0.2, 0.45),
        #         (0.0, 0.3, 0.4), (0.0, 0.4, 0.45), (0.0, 0.4, 0.55), (0.0, 0.4, 0.65),
        #         (0.0, 0.3, 0.7)  # 원을 닫기 위해 시작점으로 돌아옴
        #     ],
            
        #     # 두 번째 획 - 'ㅏ'의 세로획 (z축 방향으로 이동)
        #     [(0.0, 0.6, 0.7), (0.0, 0.6, 0.3)],
            
        #     # 세 번째 획 - 'ㅏ'의 가로획 (y축 방향으로 이동)
        #     [(0.0, 0.6, 0.5), (0.0, 0.7, 0.5)]
        # ]
        # '학(學)' 글자의 각 획 정의
        ...
        # self.strokes = [
        #     # 'ㅂ'의 왼쪽 세로획
        #     [(0.0, 0.25, 0.7), (0.0, 0.25, 0.5)],
            
        #     # 'ㅂ'의 오른쪽 세로획
        #     [(0.0, 0.35, 0.7), (0.0, 0.35, 0.5)],
            
        #     # 'ㅂ'의 위쪽 가로획
        #     # [(0.0, 0.25, 0.7), (0.0, 0.35, 0.7)],
            
        #     # 'ㅂ'의 중간 가로획
        #     [(0.0, 0.25, 0.6), (0.0, 0.35, 0.6)],
            
        #     # 'ㅂ'의 아래쪽 가로획
        #     [(0.0, 0.25, 0.5), (0.0, 0.35, 0.5)],
            
        #     # 'ㅏ'의 세로획
        #     [(0.0, 0.5, 0.7), (0.0, 0.5, 0.35)],
            
        #     # 'ㅏ'의 가로획
        #     [(0.0, 0.5, 0.55), (0.0, 0.6, 0.55)],
            
        #     # 'ㄹ'의 첫 번째 가로획
        #     [(0.0, 0.25, 0.3), (0.0, 0.45, 0.3)],
            
        #     # 'ㄹ'의 첫 번째 세로획
        #     [(0.0, 0.45, 0.3), (0.0, 0.45, 0.2)],
            
        #     # 'ㄹ'의 두 번째 가로획
        #     [(0.0, 0.25, 0.2), (0.0, 0.45, 0.2)],
            
        #     # 'ㄹ'의 두 번째 세로획
        #     [(0.0, 0.25, 0.2), (0.0, 0.25, 0.1)],
